...
func (s *TypeApi) GetSupplierApiList(c *gin.Context) {
...
func (s *TypeApi) GetSupplierById(c *gin.Context) {
...
func (s *TypeApi) DeleteSupplier(c *gin.Context) {
...
func (s *TypeApi) UpdateSupplier(c *gin.Context) {
	var api ncr.Supplier
	err := c.ShouldBindJSON(&api)
	if err != nil {
		response.FailWithMessage(err.Error(), c)
